...
// </auto-generated>
//------------------------------------------------------------------------------C:\0MyDesktop\Magistr\ANTLR\GenetatedChatListener\GenetatedChatListener\GeneratedClases\SpeakListener.cs
...
public interface ISpeakListener : IParseTreeListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="SpeakParser.compileUnit"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCompileUnit([NotNull] SpeakParser.CompileUnitContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SpeakParser.compileUnit"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCompileUnit([NotNull] SpeakParser.CompileUnitContext context);
}
